              ...
              {filteredOrders.map((item) => (
                <div className="bg-white dark:bg-[#1f1f1f] rounded-2xl p-5 border border-gray-200 dark:border-white/[0.07] overflow-hidden hover:border-gray-300 dark:hover:border-white/12 transition-colors h-full">
                  ...
                  <div className="mt-auto">
                    <button className="w-full bg-brand-primary hover:bg-brand-primary/90 text-white text-sm font-semibold py-2.5 rounded-full cursor-pointer transition-colors flex items-center justify-center gap-1.5">
                      Ver detalles
                      <ArrowRight size={14} />
                    </button>
                  </div>
